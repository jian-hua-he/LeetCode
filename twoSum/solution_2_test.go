...
func TestCase1TwoSum2(t *testing.T) {
	input := []int{2, 7, 11, 15}
	got := twoSum2(input, 9)
...
func TestCase2TwoSum2(t *testing.T) {
	input := []int{2, 5, 10, 12}
	got := twoSum2(input, 14)
...
func TestCase3TwoSum2(t *testing.T) {
	input := []int{3, 2, 4}
	got := twoSum2(input, 6)
...
func TestCase4TwoSum2(t *testing.T) {
	input := []int{4, 6, 12, 5, 2}
	got := twoSum2(input, 11)
...
func TestCase5TwoSum2(t *testing.T) {
	input := []int{-1, -2, -3, -4, -5}
	got := twoSum2(input, -8)
